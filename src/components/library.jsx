...
export default class Library extends React.Component {
    constructor(props) {
        ...
        this.libraryDefault = (<div style={ styles.textStyle }>{ `Search through your saved entries.` }</div>);
    ...
    setPreviews() {
        ...
        this.setState({ libraryResults: entries });
    }
    ...
    maximizeClick() {
        ...
        this.setState({
            maximized: maxed,
            libraryResults: this.formatEntryList(this.props.entryPreviews, maxed),
        });
    }
    ...
    render() {
        ...
        let libraryResults = Object.assign({}, styles.libraryResults, {
            display: this.props.libraryClicked ? '' : 'none',
        });
